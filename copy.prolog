...
re_comp_in([], _, []).
re_comp_in(Char, E, [(Char -> E)]) :- character(Char).
re_comp_in([Char | Chars], E, InList) :-
    re_comp_in(Char, E, InList1),
    re_comp_in(Chars, E, InList2),
    append(InList1, InList2, InList).
...
re_comp(RE1 \/ RE2, E, B, [B = epsilon([], [B1, B2]) | NFA]) :-
    new_state(B),
    re_comp(RE1, E, B1, NFA1),
